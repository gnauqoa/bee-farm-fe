...
export const HANDLE_JOINED_DEVICE_ROOM_CHANNEL = "joined_device";
export const HANDLE_LEAVED_DEVICE_ROOM_CHANNEL = "leaved_device";
export const DEVICE_DATA_CHANNEL = "device_data";